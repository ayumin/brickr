...
const expectedPaths = [
  ...
  "/api/rooms/{id}/invite",
  "/api/rooms/{id}/leave",
  "/api/rooms/{id}/invitation",
  "/api/rooms/{id}/invitation/accept",
  "/api/rooms/{id}/request",
  "/api/rooms/{id}/memberships",
  "/api/rooms/{id}/memberships/{memberId}",
  "/api/rooms/{id}/memberships/{memberId}/approve",
  "/api/rooms/{id}/memberships/{memberId}/ban",
  "/api/llm-budget",
...
const sessionProtectedOperationIds = [
  ...
  "inviteToRoom",
  "listRoomMemberships",
  "approveRoomMembershipByMemberId",
  "removeRoomMembership",
  "banRoomMemberByMemberId",
  "leaveRoom",
  "acceptRoomInvitation",
  "declineRoomInvitation",
  "withdrawRoomJoinRequest",
  "listRooms",
  "getLLMBudget",
  "setLLMBudgetLimit",
  "resetLLMBudget",
