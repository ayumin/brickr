...
/**
 * A 404 from `GET /api/handles/:handle` is a genuine, permanent answer: that
 ...
 * SimulationView's handle-resolution effect for where this classification
 * decides whether to allow a retry.
 */
